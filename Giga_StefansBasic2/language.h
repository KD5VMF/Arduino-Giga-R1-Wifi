...
/* US/MS BASIC profile: pin features consistently, regardless of board */
#if 0
...
/* Force the full feature set; dependencies below keep it coherent */
#define BASICFULL
#endif
...
/* MS BASIC–style arrays: DIM A(10) => indices 0..10 (11 elements) */
#define MSARRAYLIMITS
/* Prefer MS BASIC style default for substring handling with HASMSSTRINGS */
#define SUPPRESSSUBSTRINGS
#define USELONGJUMP 0
/* MS BASIC boolean convention: TRUE = -1, FALSE = 0 */
